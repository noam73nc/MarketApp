...
with st.expander("📖 מדריך קריאה למשתמש (Cheat Sheet) - לחץ לפתיחה", expanded=False):
    ...
    <ul>
        ...
        <li><b>Tight 🤏:</b> יום מסחר שקט במיוחד - טווח המסחר התכווץ משמעותית מתחת לממוצע עם מחזור נמוך.</li>
    ...
    <ol>
        <li>השתמשו ב<b>תפריט הצד (הסיידבר)</b> כדי לסנן מניות לפי שווי שוק, כמות מסחר (RVOL), ותבניות.</li>
        <li>עמודת ה-<b>SCORE 🎯</b> מרכזת לכם את המניות הטובות ביותר למעלה. מניות שחוצות את אזור ה-100-110 נקודות הן לרוב בעלות הסטאפים החזקים בשוק!</li>
