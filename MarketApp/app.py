...
with st.expander("📖 מדריך קריאה למשתמש (Cheat Sheet) - לחץ לפתיחה", expanded=False):
    ...
    <ul>
        ...
        <li><b>Tight 🤏:</b> יום מסחר שקט במיוחד - טווח המסחר התכווץ ב-40% מתחת לממוצע עם מחזור נמוך. הכנה לפריצה.</li>
        <li><b>2 ADR 🔥:</b> תנודתיות מטורפת. המניה זזה היום פי 2 מהתנועה הממוצעת הרגילה שלה!</li>
        <li><b>SQUAT 🏋️:</b> תמרור אזהרה. יום עם מחזור גבוה אבל המניה נסגרה בנמוך היומי שלה (פריצת שווא / מוכרים כבדים).</li>
    </ul>
    
    <p><b>איך משתמשים בלוח?</b></p>
    <ol>
        <li>השתמשו ב<b>תפריט הצד (הסיידבר)</b> כדי לסנן מניות לפי שווי שוק, כמות מסחר (RVOL), ותבניות ספציפיות.</li>
        <li>עמודת ה-<b>SCORE 🎯</b> מתעדפת את המניות עם הסטאפים האיכותיים ביותר.</li>
